...
export function TransformSection() {
  return (
    <section className="w-full max-w-[1257px] px-4 sm:px-6 mt-16 sm:mt-24 lg:mt-32 mb-4">
      {/* On mobile: Content first, then image */}
      <div className="flex flex-col lg:flex-row gap-10">
        {/* Mobile order change: On mobile, this div comes second */}
        <div className="w-full lg:w-[55%] order-2 lg:order-1 lg:pt-20">
          <div className="flex flex-col">
            <Image
              ...
              width={529}
              height={277}
              className="hidden lg:block self-end w-[80%] max-w-full"
            />
