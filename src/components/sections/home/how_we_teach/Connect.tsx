      ...
      <div className="relative w-full max-w-[1138px] mb-12 px-4 sm:px-6">
        ...
        <div className="flex flex-col lg:flex-row items-start gap-8">
          ...
          <div className="w-full lg:w-[45%] flex flex-col mt-8 lg:mt-10">
            ...
            {/* Adjusted swirly arrow positioning and display */}
            <Image
              src="/images/swirlyArrow.png"
              alt="Swirly Arrow"
              width={300}
              height={230}
              className="hidden lg:block ml-auto mt-10 sm:mt-16 md:mt-20 mr-4 sm:mr-20 max-w-[60%] sm:max-w-[70%] md:max-w-[60%] lg:max-w-[80%]"
            />
          </div>
        </div>
      </div>
