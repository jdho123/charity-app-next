  ...
  return (
    <section className="flex flex-col md:flex-row items-start">
      <div className="md:w-2/3 mb-6 md:mb-0">
        ...
        <BorderedText
          className="text-base md:text-xl text-black/80 font-urbanist font-semibold"
          lineColor="white"
        >
      ...
      <div className="md:w-1/3 md:pl-6 flex justify-center">
        <Link href="/fundraisers" className="inline-block">
          <Button
            variant="primary"
            className="text-lg md:text-xl py-3 px-6 rounded-full bg-red-600 hover:bg-red-700 text-white border-none"
          >
            Support the Cause
          </Button>
        </Link>
