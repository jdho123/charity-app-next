...
export default function PhilosophyHeader() {
    return (
      <div className="flex flex-col px-10 w-full max-md:px-5 max-md:max-w-full">
        ...
        <BorderedText className="flex flex-wrap gap-4 mt-2.5 text-2xl font-verdana">
          For pupils, we bring light to the other side of the world. For
          teachers, we highlight that by giving, we gain so much more.{" "}
