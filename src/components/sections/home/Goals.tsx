...
export default function Goals() {
  ...
  return (
    <section ref={sectionRef} className="relative min-h-[120vh] pb-32">
      {/* Background Earth Image */}
      <div className="sticky top-0 h-screen w-full pt-16 overflow-hidden">
        ...
        >
          ...
          <p className="text-lg text-gray-700 mb-8 max-w-lg">
            At LEDU, we believe that education has the power to transform lives
            and communities. That&apos;s why our mission is twofold:
          </p>
        </div>
      ...
      >
        <div className="grid gap-12 max-w-3xl">
          ...
          <div className="relative group backdrop-blur-md bg-white/70 rounded-3xl p-8 shadow-xl border border-white/20">
            <h2 className="text-3xl font-gloria text-[#1135F3] mb-4">
              Find Teachers
            </h2>
            <p className="text-lg text-gray-800 max-w-xl mb-6">
              We are searching for passionate educators who are eager to share
              their knowledge and make a lasting impact by teaching English to
              children in need around the globe.
            </p>
            <Link
              href="/apply_to_teach"
          ...
          {/* Schools Section */}
          <div className="relative group backdrop-blur-md bg-white/70 rounded-3xl p-8 shadow-xl border border-white/20">
            <h2 className="text-3xl font-gloria text-[#53A21A] mb-4">
              Find Schools
            </h2>
            <p className="text-lg text-gray-800 max-w-xl mb-6">
              We aim to connect with schools in underserved regions, providing
              them with access to resources, support, and transformative
