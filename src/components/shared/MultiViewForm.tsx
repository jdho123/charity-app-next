    ...
    if (showReviewStep && currentView === allViews.length) {
      return (
        <div className="bg-white/20 rounded-3xl p-6 md:p-8 border-2 border-white/40">
          <h2
            className={`text-${labelColor} text-2xl font-gloria mb-6 text-center`}
          >
          ...
          <div className="flex items-start gap-4 mb-8">
            ...
            <label
              htmlFor="terms"
              className={`text-base font-verdana text-${labelColor}`}
            >
          ...
          <div key={field.id} className="relative">
            ...
            {field.type === "textarea" ? (
              ...
              <div className="flex items-center">
                ...
                <label
                  htmlFor={field.id}
                  className="ml-2 text-lg font-verdana text-white"
                >
                  {field.label}
                </label>
              </div>
  ...
  return (
    ...
    >
      <div className="max-w-3xl mx-auto px-4 w-full flex-1 flex flex-col overflow-auto pb-24 pt-6 md:pt-8">
        <form
          className="space-y-8 md:space-y-12 flex-1 flex flex-col"
        ...
        <div className="max-w-3xl mx-auto flex justify-between items-center px-4 py-2 border-t border-white/20">
          ...
          <div className="flex items-center">
            {getProgressImage(currentView) || (
              <div className="h-10 w-10 md:h-12 md:w-12 bg-white/30 rounded-full"></div>
            )}
